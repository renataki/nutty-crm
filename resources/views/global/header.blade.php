<body>
    ...
    <div id="layout-wrapper">
        <base ng-init="initializeGlobal()" data-application-name="{{Component::appName()}}" data-cookie-path="" data-cookie-prefix="" data-datetime-format="" data-datetime-offset="" data-datetime-timezone="" data-url-audio="" data-url-base="{{Component::appUrl()}}" data-url-html="" data-url-image="" data-url-video="" data-url-websocket="" />
            ...
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    <div class="dropdown d-inline-block d-lg-none ms-2">
                        <button id="page-header-search-dropdown" class="btn header-item noti-icon waves-effect" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown d-inline-block language-switch">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{asset("resources/images/spain.jpg")}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{asset("resources/images/germany.jpg")}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Germany</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{asset("resources/images/italy.jpg")}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{asset("resources/images/russia.jpg")}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                            </a>
                        </div>
                    </div>
                    <div class="dropdown d-none d-lg-inline-block ms-1">
                        <button class="btn header-item noti-icon waves-effect" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="uil-apps"></i>
                        </button>
                    ...
                    <div class="dropdown d-inline-block">
                        <button id="page-header-notifications-dropdown" class="btn header-item noti-icon waves-effect" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="uil-bell"></i>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="javascript:void(0);" class="text-reset notification-item">
                                    <div class="d-flex align-items-start">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{asset("resources/images/avatar-3.jpg")}}" class="rounded-circle avatar-xs" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="text-reset notification-item">
                                    <div class="d-flex align-items-start">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{asset("resources/images/avatar-4.jpg")}}" class="rounded-circle avatar-xs" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1">
                    ...
                    <div class="dropdown d-inline-block">
                        <button id="page-header-user-dropdown" class="btn header-item waves-effect" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{asset("resources/images/avatar-4.jpg")}}" alt="Header Avatar">
