...
class UserGroupService {
    ...
    public static function delete($request) {
        ...
        $userGroupById = UserGroupRepository::findOneById($request->id);
    ...
    public static function initializeData($request) {
        ...
        $result->userGroup = UserGroupRepository::findOneById($request->id);
    ...
    public static function insert($request) {
        ...
        if($validation->result) {
            ...
            UserGroupRepository::insert(DataComponent::initializeAccount($request), $validation->userGroup);
    ...
    public static function update($request) {
        ...
        if($validation->result) {
            ...
            UserGroupRepository::update(DataComponent::initializeAccount($request), $validation->userGroup);
            ...
            UserRepository::updateByGroupId($validation->userGroup->_id, $update);
    ...
    public static function updateWebsiteNames($websiteId, $websiteName) {
        ...
        $userGroupByWebsiteIdsNotWebsiteNames = UserGroupRepository::findOneByWebsiteIdsNotWebsiteNames($websiteId, $websiteName);
        ...
        while(!empty($userGroupByWebsiteIdsNotWebsiteNames)) {
            ...
            if(gettype($index) == "integer") {
                ...
                UserGroupRepository::update(null, $userGroupByWebsiteIdsNotWebsiteNames);
    ...
    public static function validateData($request) {
        ...
        $result->userGroup->website = [
            "ids" => $request->website["ids"],
            "names" => []
        ];

        $userGroupByNameNucode = UserGroupRepository::findOneByNameNucode($request->name, $request->nucode);
        ...
        if(empty($validation)) {
            ...
            $websitesInId = WebsiteRepository::findInId($result->userGroup->website["ids"]);
            $websiteNames = [];
