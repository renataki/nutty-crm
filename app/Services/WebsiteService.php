...
class WebsiteService {
    ...
    public static function delete($request) {
        ...
        $websiteById = WebsiteRepository::findOneById($request->id);

        if(!empty($websiteById)) {

            WebsiteRepository::delete($websiteById);
    ...
    public static function insert($request) {
        ...
        if($validation->result) {
            ...
            $websiteLast = WebsiteRepository::insert(DataComponent::initializeAccount($request), $validation->website);
    ...
    public static function validateData($request, $api) {
        ...
        if($api) {
            ...
            $websiteByNameNucode = WebsiteRepository::findOneByNameNucode($request->name, $request->nucode);
