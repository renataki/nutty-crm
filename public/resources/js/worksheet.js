        ...
        $scope.$on("initializeTable", function() {
            ...
            let table = $("#worksheet-follow-up").DataTable({
                "ajax": {
                    ...
                    "datatype": "json",
                    "type": "POST",
                    "url": $scope.global.url.base + "/worksheet/follow-up/table/"
                },
                "columns": [
                    {
                        "data": "database",
            ...
            table = $("#worksheet-result").DataTable({
                "ajax": {
                    ...
                    "datatype": "json",
                    "type": "POST",
                    "url": $scope.global.url.base + "/worksheet/result/table/"
                },
                "columns": columns,
                "createdRow": function(row) {
                    $compile(angular.element(row).contents())($scope);
            ...
            if(userGroup != null) {
                ...
                angular.forEach(userGroup.website.ids, function(value, key) {
                    ...
                    $scope.websites.option.push({
                        "_id": value,
                        "name": userGroup.website.names[key]
                    });
