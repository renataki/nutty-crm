app.controller("user", ["$scope", "$window", "$compile", "$timeout", "global", function($scope, $window, $compile, $timeout, global) {
    ...
    $scope.$on("initializeTable", function() {
        ...
        let columns = [{
            ...
            "data": "group.name", "name": "group._id"
        }, {
            "data": "role.name", "name": "role._id"
        }, {
        ...
        let table = $("#user").DataTable({
            "ajax": {
                ...
                }, "datatype": "json", "type": "POST", "url": $scope.global.url.base + "/user/table/"
            },
            "columns": columns,
    ...
    $scope.initializeInputNewPassword = function() {
        ...
        return {
            "_token": $("meta[name=\"csrf-token\"]").attr("content"), "password": {
                "main": $scope.password.value
            }
        };
    ...
    $scope.insert = function(event) {
        ...
        if(validation) {
            ...
            let rest = {
                "data": $scope.initializeInputData(), "url": $scope.global.url.base + "/user/insert/"
            };
            global.rest(rest, function(response) {
    ...
    $scope.update = function(event) {
        ...
        if(validation) {
            ...
            let rest = {
                "data": data, "url": $scope.global.url.base + "/user/update"
            };
            global.rest(rest, function(response) {
    ...
    $scope.updatePassword = function(event) {
        ...
        if(validation) {
            ...
            let rest = {
                "data": data, "url": $scope.global.url.base + "/user/update-password"
            };
            global.rest(rest, function(response) {
