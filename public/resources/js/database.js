app.controller("database", ["$scope", "$window", "$compile", "$timeout", "global", function($scope, $window, $compile, $timeout, global) {
    ...
    $(document).ready(function() {
        ...
        let table = $("#database").DataTable({
            "ajax": {
                ...
                }, "datatype": "json", "type": "POST", "url": $scope.global.url.base + "/database/table/"
            },
            "columns": [{
                ...
                "data": "contact.phone", "name": "contact.phone", "render": function(data) {
                    let result = "";
                ...
                "data": "telemarketer.username", "name": "telemarketer._id"
            }, {
                "data": "crm.username", "name": "crm._id"
            }, {
