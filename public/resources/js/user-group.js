app.controller("userGroup", ["$scope", "$window", "$compile", "$timeout", "global", function($scope, $window, $compile, $timeout, global) {
    ...
    $scope.$on("initializeTable", function() {
        ...
        let columns = [{
            ...
            "data": "website.names", "name": "website.ids", "render": function(data) {
                let result = "";
        ...
        let table = $("#user-group").DataTable({
            "ajax": {
                ...
                }, "datatype": "json", "type": "POST", "url": $scope.global.url.base + "/user/group/table/"
            },
            "columns": columns,
    ...
    $scope.initializeInputData = function() {
        ...
        return {
            ...
            "website": {
                "ids": $scope.websites.value, "names": []
            }
        };
    ...
    $scope.insert = function(event) {
        ...
        if(validation) {
            ...
            let rest = {
                "data": $scope.initializeInputData(), "url": $scope.global.url.base + "/user/group/insert/"
            };
            global.rest(rest, function(response) {
    ...
    $scope.update = function(event) {
        ...
        if(validation) {
            ...
            let rest = {
                "data": data, "url": $scope.global.url.base + "/user/group/update"
            };
            global.rest(rest, function(response) {
