    ...
    $(document).ready(function() {
        ...
        let table = $("#database-import-history").DataTable({
            "ajax": {
                ...
                }, "datatype": "json", "type": "POST", "url": $scope.global.url.base + "/database/import/history/table/"
            },
            "columns": [{
                ...
                "data": "website.name", "name": "website._id"
            }, {
                ...
                "data": "modified.user.username", "name": "modified.user._id"
            }, {
